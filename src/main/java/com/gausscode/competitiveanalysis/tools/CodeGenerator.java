...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("hudl");    //设置作者
        ...
        packageInfo.setParent("com.idp.business");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        ...
        strategyConfig.setInclude("jwtparams");  //设置当前参与生成的表名，参数为可变参数，写你的数据库表名即可
